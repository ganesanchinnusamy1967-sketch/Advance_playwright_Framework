...
// Local type alias for guest customer data to avoid import issues during build
...
export class CheckoutStepOnePage extends BasePage {
    ...
    async fillGuest(g: GuestUser): Promise<void> {
        await this.util.fill(this.firstNameInput, g.firstName);
        await this.util.fill(this.lastNameInput, g.lastName);
        await this.util.fill(this.postalCodeInput, g.postalCode);
    }

    async continue(): Promise<void> {
        await this.util.click(this.continueButton);
    ...
    async cancel(): Promise<void> {
        await this.util.click(this.cancelButton);
    ...
    async firstNameValue(): Promise<string> {
        return this.util.getValue(this.firstNameInput);
    }
}